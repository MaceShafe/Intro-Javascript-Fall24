...
function tilt(e) {
    let diffBeta,diffGamma,diffAlpha;
    for (let i=0; i<tiltyTable.children.length; i++) {
        ...
        tiltyTable.children[i].style.top = elemRect.top - diffBeta*2 + "px";
        tiltyTable.children[i].style.left = elemRect.left - diffGamma*.8 + "px";
